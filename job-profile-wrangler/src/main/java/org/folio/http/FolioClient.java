...
public class FolioClient {
  ...
  public FolioClient(Supplier<HttpUrl.Builder> baseUrlBuilderSupplier, String tenantId, String username,
                     String password) {
    this.baseUrlBuilderSupplier = baseUrlBuilderSupplier;
  ...
  protected Optional<String> getOkapiToken(HttpUrl.Builder baseUrlBuilder, String tenantId, String username,
                                           String password) {
