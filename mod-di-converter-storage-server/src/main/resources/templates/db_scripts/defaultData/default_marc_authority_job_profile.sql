...
$$
DECLARE
    job_wrapper_id UUID := '790f2fce-b2b7-4033-ac92-7b683d30bede';
    action_wrapper_id UUID := '570476c2-2309-4a66-be93-eef158882f66';
    mapping_wrapper_id UUID := 'b5befbad-caac-4f05-8e94-6a292a1fbe17';
BEGIN
    IF NOT EXISTS (SELECT 1 FROM ${myuniversity}_${mymodule}.profile_wrappers WHERE job_profile_id = '6eefa4c6-bbf7-4845-ad82-de7fc5abd0e3') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM ${myuniversity}_${mymodule}.profile_wrappers WHERE action_profile_id = '7915c72e-c6af-4962-969d-403c7238b051') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM ${myuniversity}_${mymodule}.profile_wrappers WHERE mapping_profile_id = '6a0ec1de-68eb-4833-bdbf-0741db25c314') THEN
