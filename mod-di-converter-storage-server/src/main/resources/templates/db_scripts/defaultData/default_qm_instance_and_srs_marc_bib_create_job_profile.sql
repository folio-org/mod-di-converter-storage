...
DO $$
DECLARE
    job_wrapper_id UUID := '8d802fef-b077-4eff-8997-a22edbbdd901';
    action_wrapper_id UUID := '1591ec40-579c-4dde-9692-1b0b779905c1';
    mapping_wrapper_id UUID := '48fde3e4-f3bf-45ab-bcc5-55cd0e3c4b00';
BEGIN
  IF NOT EXISTS (SELECT 1 FROM ${myuniversity}_${mymodule}.profile_wrappers WHERE job_profile_id = '6409dcff-71fa-433a-bc6a-e70ad38a9604') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM ${myuniversity}_${mymodule}.profile_wrappers WHERE action_profile_id = 'f8e58651-f651-485d-aead-d2fa8700e2d1') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM ${myuniversity}_${mymodule}.profile_wrappers WHERE mapping_profile_id = '991c0300-44a6-47e3-8ea2-b01bb56a38cc') THEN
