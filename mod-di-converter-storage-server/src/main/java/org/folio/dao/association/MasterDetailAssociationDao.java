...
public interface MasterDetailAssociationDao {
   ...
   */
  Future<List<ProfileSnapshotWrapper>> getDetailProfilesByMasterId(String masterId, ProfileType detailType,
   ...
   */
  Future<List<ProfileSnapshotWrapper>> getMasterProfilesByDetailId(String detailId, ProfileType masterType,
                                                                   String query, int offset, int limit,
                                                                   String tenantId);
}
