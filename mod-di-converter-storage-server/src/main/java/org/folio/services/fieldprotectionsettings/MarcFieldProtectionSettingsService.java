...
public interface MarcFieldProtectionSettingsService {
   ...
   */
  Future<MarcFieldProtectionSettingsCollection> getMarcFieldProtectionSettings(String query, int offset, int limit,
                                                                               String tenantId);
   ...
   */
  Future<MarcFieldProtectionSetting> addMarcFieldProtectionSetting(
   ...
   * @return future with {@link MarcFieldProtectionSetting}
   */
  Future<MarcFieldProtectionSetting> updateMarcFieldProtectionSetting(
    MarcFieldProtectionSetting marcFieldProtectionSetting, String tenantId);
