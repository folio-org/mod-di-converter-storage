...
public class CommonProfileAssociationTest extends AbstractRestVerticleTest {
  ...
  public void shouldReturnEmptyOkResultOnGetAll(TestContext testContext, ProfileType masterProfileType,
  ...
  public void runTestShouldReturnProfileAssociationListOnGet(TestContext testContext) {
    // action to mapping
    shouldReturnProfileAssociationListOnGet(testContext, new ActionProfileWrapper(actionProfile3),
    ...
    // job to match
    shouldReturnJobToMatchAssociationListOnGet(testContext, new JobProfileWrapper(jobProfile2),
    ...
    // match to match
    shouldReturnProfileAssociationListOnGet(testContext, new MatchProfileWrapper(matchProfile2),
  ...
  public void runTestShouldPostAndGetById(TestContext testContext) {
    ...
    shouldPostJobToActionAndGetById(testContext, new JobProfileWrapper(jobProfile1),
      new ActionProfileWrapper(actionProfile1), new MappingProfileWrapper(mappingProfile1));
    // job to match
    shouldPostJobToMatchAndGetById(testContext, new JobProfileWrapper(jobProfile2),
      new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1), new MatchProfileWrapper(matchProfile1));
    // match to action
  ...
  public <M, D> void shouldPostAndGetById(TestContext testContext, ProfileWrapper<M> masterProfileWrapper,
                                          ProfileWrapper<D> detailProfileWrapper,
                                          String masterProfileUrl, String detailProfileUrl,
                                          ProfileType masterContentType, ProfileType detailContentType) {
  ...
  public void shouldReturnNotFoundOnDelete(TestContext testContext, ProfileType masterProfileType,
                                           ProfileType detailProfileType) {
    Async async = testContext.async();
    RestAssured.given()
      .spec(spec)
  ...
  public void runTestShouldDeleteProfileOnDelete(TestContext testContext) {
    // action to mapping
    shouldDeleteProfileOnDelete(testContext, new ActionProfileWrapper(actionProfile3),
      new MappingProfileWrapper(mappingProfile1),
      ACTION_PROFILES_URL, MAPPING_PROFILES_URL, ACTION_PROFILE, MAPPING_PROFILE);
    // job to action
    shouldDeleteJobToActionOnDelete(testContext, new JobProfileWrapper(jobProfile1),
      new ActionProfileWrapper(actionProfile1), new MappingProfileWrapper(mappingProfile1));
    // job to match
    shouldDeleteJobToMatchOnDelete(testContext, new JobProfileWrapper(jobProfile2),
      new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1), new MatchProfileWrapper(matchProfile1));
    // match to action
    ...
    // match to match
    shouldDeleteProfileOnDelete(testContext, new MatchProfileWrapper(matchProfile1),
      new MatchProfileWrapper(matchProfile2),
      MATCH_PROFILES_URL, MATCH_PROFILES_URL, MATCH_PROFILE, MATCH_PROFILE);
  }

  public <M, D> void shouldDeleteProfileOnDelete(TestContext testContext, ProfileWrapper<M> masterWrapper,
  ...
  public void shouldReturnBadRequestOnPut(TestContext testContext, ProfileType masterContentType,
  ...
  public void runTestShouldReturnNotFoundOnPut(TestContext testContext) {
    ...
    final JobProfileWrapper existingJobProfileWrapper = new JobProfileWrapper(new JobProfileUpdateDto()
    ...
    shouldReturnNotFoundOnPut(testContext, ACTION_PROFILE, MAPPING_PROFILE, actionProfileId, mappingProfileId,
      ProfileType.ACTION_PROFILE, ProfileType.MAPPING_PROFILE);
    shouldReturnNotFoundOnPutJobToAction(testContext, existingJobProfileWrapper, actionProfileId, mappingProfileId,
      firstMatchProfileId);
    shouldReturnNotFoundOnPut(testContext, ACTION_PROFILE, MATCH_PROFILE, actionProfileId, firstMatchProfileId,
      ProfileType.ACTION_PROFILE, ProfileType.MATCH_PROFILE);
    shouldReturnNotFoundOnPut(testContext, MATCH_PROFILE, ACTION_PROFILE, firstMatchProfileId, actionProfileId,
      ProfileType.MATCH_PROFILE, ProfileType.ACTION_PROFILE);
    shouldReturnNotFoundOnPut(testContext, MATCH_PROFILE, MATCH_PROFILE, firstMatchProfileId, secondMatchProfileId,
      ProfileType.MATCH_PROFILE, ProfileType.MATCH_PROFILE);
  }
  ...
  public void shouldReturnNotFoundOnPut(TestContext testContext, ProfileType masterContentType,
                                        ProfileType detailContentType, String masterId, String detailId,
  ...
  public void runTestShouldUpdateProfileAssociationOnPut(TestContext testContext) {
    // action to mapping
    shouldUpdateProfileAssociationOnPut(testContext, new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1),
      new MappingProfileWrapper(mappingProfile2), ACTION_PROFILES_URL, MAPPING_PROFILES_URL, ACTION_PROFILE,
      MAPPING_PROFILE);
  ...
  public <M, D> void shouldUpdateProfileAssociationOnPut(TestContext testContext, ProfileWrapper<M> masterWrapper,
                                                         ProfileWrapper<D> detailWrapper,
  ...
  public void runTestGetDetailsByMasterProfile_Ok(TestContext testContext) {
    ...
    getDetailProfilesByMasterProfile_Ok(testContext, new ActionProfileWrapper(actionProfile1),
      new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1), new MappingProfileWrapper(mappingProfile2), ACTION_PROFILES_URL,
      MAPPING_PROFILES_URL, ACTION_PROFILE, MAPPING_PROFILE);
    // job to match to action
    ...
    getDetailProfilesByMasterProfile_Ok(testContext, new MatchProfileWrapper(matchProfile1),
      new MatchProfileWrapper(matchProfile2), new ActionProfileWrapper(actionProfile1),
      new ActionProfileWrapper(actionProfile2), MATCH_PROFILES_URL,
  ...
  public void runTestGetDetailsByMasterProfile_emptyDetailsListWithMasterProfile(TestContext testContext) {
    ...
    getDetailsByMasterProfile_emptyDetailsListWithMasterProfile(testContext, new MatchProfileWrapper(matchProfile1),
      MATCH_PROFILES_URL, MATCH_PROFILE);
  }

  public <M> void getDetailsByMasterProfile_emptyDetailsListWithMasterProfile(TestContext testContext,
                                                                              ProfileWrapper<M> masterWrapper,
                                                                              String masterProfileUrl,
  ...
  public void runTestGetDetailProfilesByMasterProfile_sortByName_Ok(TestContext testContext) {
    // action to mapping
    getDetailProfilesByMasterProfile_sortByName_Ok(testContext, new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1),
      new MappingProfileWrapper(mappingProfile2), new MappingProfileWrapper(mappingProfile3), ACTION_PROFILES_URL,
      MAPPING_PROFILES_URL, ACTION_PROFILE, MAPPING_PROFILE);
    // job to action
    ...
    getDetailProfilesByMasterProfile_sortByName_Ok(testContext, new MatchProfileWrapper(matchProfile1),
      new ActionProfileWrapper(actionProfile1),
      new ActionProfileWrapper(actionProfile2), new ActionProfileWrapper(actionProfile4), MATCH_PROFILES_URL,
      ACTION_PROFILES_URL, MATCH_PROFILE, ACTION_PROFILE);
    // match to match
    getDetailProfilesByMasterProfile_sortByName_Ok(testContext, new MatchProfileWrapper(matchProfile1),
      new MatchProfileWrapper(matchProfile2),
      new MatchProfileWrapper(matchProfile3), new MatchProfileWrapper(matchProfile4), MATCH_PROFILES_URL,
      MATCH_PROFILES_URL, MATCH_PROFILE, MATCH_PROFILE);
  }

  @Test
  public void runTestGetMastersByDetailProfile_Ok(TestContext testContext) {
    // action to mapping
    getMastersByDetailProfile_Ok(testContext, new ActionProfileWrapper(actionProfile3),
      new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1), new MappingProfileWrapper(mappingProfile2),
      ACTION_PROFILES_URL, MAPPING_PROFILES_URL, ACTION_PROFILE, MAPPING_PROFILE);
    // job to match, match to action
    getMastersJobToMatchToActionByDetailProfile_Ok(testContext, new JobProfileWrapper(jobProfile1),
      new ActionProfileWrapper(actionProfile2),
      new MappingProfileWrapper(mappingProfile1), new MatchProfileWrapper(matchProfile1));
    // match to action
    getMastersByDetailProfile_Ok(testContext, new MatchProfileWrapper(matchProfile1),
      new MatchProfileWrapper(matchProfile2),
  ...
  public void runTestGetMastersByDetailProfile_emptyMastersListWithDetailProfile(TestContext testContext) {
    ...
    getMastersByDetailProfile_emptyMastersListWithDetailProfile(testContext, new MatchProfileWrapper(matchProfile1),
      MATCH_PROFILES_URL, MATCH_PROFILE);
    // action to mapping
    getMastersByDetailProfile_emptyMastersListWithDetailProfile(testContext, new MappingProfileWrapper(mappingProfile1),
      MAPPING_PROFILES_URL, MAPPING_PROFILE);
  }

  public <D> void getMastersByDetailProfile_emptyMastersListWithDetailProfile(TestContext testContext,
                                                                              ProfileWrapper<D> detailWrapper,
  ...
  public void runTestGetMastersByDetailProfile_sortBy_Ok(TestContext testContext) {
    // action to mapping
    getMastersByDetailProfile_sortBy_Ok(testContext, new ActionProfileWrapper(actionProfile1),
      new ActionProfileWrapper(actionProfile2), new ActionProfileWrapper(actionProfile4),
      new MappingProfileWrapper(mappingProfile1), ACTION_PROFILES_URL, MAPPING_PROFILES_URL, ACTION_PROFILE,
      MAPPING_PROFILE);
    // job to match, match to action
    getMastersJobToMatchToActionByDetailProfile_sortBy_Ok(testContext, new JobProfileWrapper(jobProfile1),
      new ActionProfileWrapper(actionProfile1),
      new MappingProfileWrapper(mappingProfile1), new MatchProfileWrapper(matchProfile1));
    // match to action
    getMastersByDetailProfile_sortBy_Ok(testContext, new MatchProfileWrapper(matchProfile2),
      new MatchProfileWrapper(matchProfile3), new MatchProfileWrapper(matchProfile4),
      new ActionProfileWrapper(actionProfile1), MATCH_PROFILES_URL, ACTION_PROFILES_URL, MATCH_PROFILE, ACTION_PROFILE);
    // match to match
    getMastersByDetailProfile_sortBy_Ok(testContext, new MatchProfileWrapper(matchProfile2),
  ...
  @SuppressWarnings("checkstyle:MethodLength")
  private <M, D> void getMastersByDetailProfile_sortBy_Ok(TestContext testContext,
                                                          ...
                                                          ProfileType masterProfileType,
                                                          ProfileType detailProfileType) {
    final ProfileWrapper<D> detailWrapper = postProfile(testContext, detailProfileWrapper, detailProfileUrl);
    final ProfileWrapper<M> masterWrapper3 = postProfile(testContext, masterProfileWrapper3, masterProfileUrl);
    final ProfileWrapper<M> masterWrapper2 = postProfile(testContext, masterProfileWrapper2, masterProfileUrl);
    final ProfileWrapper<M> masterWrapper1 = postProfile(testContext, masterProfileWrapper1, masterProfileUrl);
  ...
  @SuppressWarnings("checkstyle:MethodLength")
  private <M, D> void getMastersByDetailProfile_Ok(TestContext testContext, ProfileWrapper<M> masterWrapper,
    ...
    final ProfileAssociation profileAssociation1 = new ProfileAssociation()
    ...
    final ProfileAssociation profileAssociation2 = new ProfileAssociation()
  ...
  @SuppressWarnings("checkstyle:MethodLength")
  private <M, D> void getDetailProfilesByMasterProfile_sortByName_Ok(TestContext testContext,
                                                                     ProfileWrapper<M> masterWrapper,
                                                                     ProfileWrapper<D> detailWrapper,
                                                                     ProfileWrapper<D> detailWrapper2,
  ...
  @SuppressWarnings("checkstyle:MethodLength")
  private <M, D> void getDetailProfilesByMasterProfile_Ok(TestContext testContext, ProfileWrapper<M> masterWrapper,
                                                          ProfileWrapper<M> masterWrapper2,
                                                          ProfileWrapper<D> detailWrapper,
                                                          ProfileWrapper<D> detailWrapper2,
                                                          String masterProfileUrl, String detailProfileUrl,
  ...
  private void shouldReturnJobToActionAssociationListOnGet(TestContext testContext,
                                                           JobProfileWrapper jobProfileWrapper,
  ...
  private void shouldReturnJobToMatchAssociationListOnGet(TestContext testContext,
                                                          JobProfileWrapper jobProfileWrapper,
                                                          ActionProfileWrapper actionProfileWrapper,
                                                          MappingProfileWrapper mappingProfileWrapper,
  ...
  private <M, D> void shouldReturnProfileAssociationListOnGet(TestContext testContext, ProfileWrapper<M> masterWrapper1,
  ...
  private void shouldReturnNotFoundOnGetById(TestContext testContext, ProfileType masterProfileType,
                                             ProfileType detailProfileType) {
    Async async = testContext.async();
    RestAssured.given()
      .spec(spec)
  ...
  private void shouldDeleteJobToActionOnDelete(TestContext testContext,
                                               JobProfileWrapper jobProfileWrapper,
                                               ActionProfileWrapper actionProfileWrapper,
                                               MappingProfileWrapper mappingProfileWrapper) {
    var jobProfile = createJobProfileWithAction(testContext, jobProfileWrapper, actionProfileWrapper,
  ...
  private void shouldDeleteJobToMatchOnDelete(TestContext testContext,
                                              JobProfileWrapper jobProfileWrapper,
                                              ActionProfileWrapper actionProfileWrapper,
                                              MappingProfileWrapper mappingProfileWrapper,
                                              MatchProfileWrapper matchProfileWrapper) {
  ...
  private void shouldUpdateJobToMatchAssociationOnPut(TestContext testContext,
                                                      JobProfileWrapper jobProfileWrapper,
                                                      ActionProfileWrapper actionProfileWrapper,
                                                      MappingProfileWrapper mappingProfileWrapper,
                                                      MatchProfileWrapper matchProfileWrapper) {
  ...
  private void getDetailProfilesByMasterProfile_OkJobToMatchToAction(TestContext testContext,
                                                                     JobProfileWrapper jobProfileWrapper,
                                                                     ActionProfileWrapper actionProfileWrapper,
                                                                     MappingProfileWrapper mappingProfileWrapper,
                                                                     MatchProfileWrapper matchProfileWrapper) {
  ...
  private void getDetailsJobToMatchToActionByMasterProfile_emptyDetailsListWithMasterProfile(
  ...
  private void getDetailProfilesJobToMatchByMasterProfile_sortByName_Ok(TestContext testContext,
                                                                        JobProfileWrapper jobProfileWrapper,
                                                                        ActionProfileWrapper actionProfileWrapper,
                                                                        MappingProfileWrapper mappingProfileWrapper,
                                                                        MatchProfileWrapper matchProfileWrapper) {
  ...
  private void getMastersJobToMatchToActionByDetailProfile_Ok(TestContext testContext,
                                                              JobProfileWrapper jobProfileWrapper,
                                                              ActionProfileWrapper actionProfileWrapper,
                                                              MappingProfileWrapper mappingProfileWrapper,
                                                              MatchProfileWrapper matchProfileWrapper) {
  ...
  private void getMastersJobToMatchToActionByDetailProfile_sortBy_Ok(TestContext testContext,
                                                                     JobProfileWrapper jobProfileWrapper,
                                                                     ActionProfileWrapper actionProfileWrapper,
                                                                     MappingProfileWrapper mappingProfileWrapper,
                                                                     MatchProfileWrapper matchProfileWrapper) {
  ...
  private <T> ProfileWrapper<T> postProfile(TestContext testContext, ProfileWrapper<T> profileWrapper,
                                            String profileUrl) {
    Async async = testContext.async();
